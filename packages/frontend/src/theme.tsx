...
const brandPalette: PaletteOptions = {
  brand: {
    ...
    gray5:
      "#1F1F1F" /* Charcoal used in "How does STAR Voting Work?" graphic */,
    ...
    grayAlpha:
      "#7B7B7B7D" /* For graying out candidates for the "How does STAR Voting Work?" Graphic (has transparency)*/,
  },
};
