  ...
  return (
    <Container>
      ...
      >
        ...
        <br />
        <Typography>
          It gives you an easy way to create secure elections with voting
          methods that don&apos;t spoil the vote.
        </Typography>
        <br />
        <Typography>
        ...
        <br />
        <Typography>
          It&apos;s also flexible to fit your voting scenario, whether it&apos;s
          a massive public poll, a high stakes board election, or just a casual
          poll picking a restaurant
        ...
        <ul>
          <li>
            Mike Franze (<a href="https://github.com/mikefranze">@mikefranze</a>
            ): Software Development Project Lead
          </li>
          <li>
            Arend Peter Castelein (
            <a href="https://github.com/ArendPeter">@ArendPeter</a>): Equal Vote
            Production Lead
          </li>
          <li>
            Evans Tucker (
            <a href="https://github.com/evanstucker-hates-2fa">
              @evanstucker-hates-2fa
            </a>
            ): Infrastructure Lead
          </li>
          <li>
            Sara Wolk (<a href="https://github.com/SaraWolk">@SaraWolk</a>):
            Equal Vote Director
          </li>
        </ul>
        ...
        >
          {allContributors.map(([name, id]) => (
            <a key={id} href={`https://github.com/${name}`}>
              <Box
                key={id}
                component="img"
        ...
        <Typography>
          ...
          <a href="https://github.com/Equal-Vote/star-server">GitHub</a>, Pull
          Requests and Bug Reports are appreciated
        </Typography>
        <br />
        <Typography>
          <a href="https://www.starvoting.org/join">Join our community</a> for
          onboarding and to be involved in discussions
        </Typography>

        <h1>Donate</h1>

        <Typography>Help us to continue supporting the website</Typography>
