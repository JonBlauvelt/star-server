...
const VoterAuth = () => {
  ...
  const [voterID, setVoterID] = useCookie(
    "voter_id",
          ...
          {voterIdRequired && voter_id !== undefined && isAuthorized && (
            ...
            >
              ...
              <p>
                ...
                {voter_id
                  .split("-")
                  .map((str, i) => (i == 0 ? str : str.replace(/./g, "●")))
                  .join("-")}
              </p>
            </Box>
          )}
              ...
              <Box sx={{ display: "flex" }}>
                ...
                {(!isAuthorized || missingVoterID) && (
                  <Box sx={{ p: 1, display: "flex", justifyContent: "center" }}>
                    <Button variant="outlined" onClick={() => submitVoterID()}>
                      {" "}
                      Submit{" "}
                    </Button>
                  </Box>
                ...
                {isAuthorized && voterID && (
                  <Box sx={{ p: 1, display: "flex", justifyContent: "center" }}>
                    <Button variant="outlined" onClick={() => clearVoterID()}>
                      {" "}
                      Clear{" "}
                    </Button>
                  </Box>
