...
export default function ElectionSettings() {
  ...
  const [editedElectionSettings, setEditedElectionSettings] = useState(
    election.settings,
  );
          ...
          <Grid item xs={12} sx={{ m: 0, my: 1, p: 1 }}>
            <FormControl component="fieldset" variant="standard">
              <FormGroup>
                    ...
                    <Checkbox
                      ...
                      onChange={(e) =>
                        applySettingsUpdate((settings) => {
                          settings.random_candidate_order = e.target.checked;
                        })
                      }
                    />
                  }
                ...
                />
                <FormHelperText sx={{ pl: 4, mt: -1 }}>
                  Allow voters to update their ballots while election is still
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={(e) =>
                        applySettingsUpdate((settings) => {
                          settings.public_results = e.target.checked;
                        })
                      }
                    />
                  }
                ...
                />
                <FormHelperText sx={{ pl: 4, mt: -1 }}>
                  Allow voters to view preliminary results. (Administrators can
                  make results public at any time.)
                </FormHelperText>
                <FormControlLabel
                  disabled={true}
                  control={
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        editedElectionSettings.require_instruction_confirmation
                      }
                      onChange={(e) =>
                        applySettingsUpdate((settings) => {
                          settings.require_instruction_confirmation =
                            e.target.checked;
                        })
                      }
                    />
                ...
                />
                <FormHelperText sx={{ pl: 4, mt: -1 }}>
                  Requires voters to confirm that they have read ballot
