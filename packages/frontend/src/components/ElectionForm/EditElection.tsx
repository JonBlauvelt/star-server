...
const EditElection = () => {
  ...
  const { isPending, makeRequest: editElection } = useEditElection(
    ...
    <Container>
      <>
        ...
        {authSession.isLoggedIn() &&
          authSession.getIdField("sub") == election.owner_id && (
            <ElectionForm
              authSession={authSession}
              onSubmitElection={onEditElection}
              prevElectionData={election}
              submitText="Apply Updates"
