...
const QuickPoll = ({ authSession }) => {
  ...
  const [election, setElectionData] = useLocalStorage<NewElection>(
    "QuickPoll",
    QuickPollTemplate,
  );
  ...
  const onSubmit = (e) => {
    ...
    const newElection = {
      ...
      owner_id: authSession.isLoggedIn()
  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      >
        ...
        <StyledButton type="submit" variant="contained" disabled={isPending}>
          Create Quick Poll
        </StyledButton>
