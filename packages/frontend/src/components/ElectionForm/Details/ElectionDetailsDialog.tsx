...
export default function ElectionDetails3() {
  const { editedElection, applyUpdate, onSave, errors, setErrors } =
    useEditElectionDetails();
      ...
      >
        ...
        <Grid xs={12}>
          <Typography gutterBottom component="p">
            Start Time:{" "}
            {election.start_time
              ? formatDate(election.start_time, election.settings.time_zone)
              : "none"}
          </Typography>
        </Grid>
        <Grid xs={12}>
          <Typography gutterBottom component="p">
            End Time:{" "}
            {election.end_time
              ? formatDate(election.end_time, election.settings.time_zone)
              : "none"}
          </Typography>
        </Grid>
