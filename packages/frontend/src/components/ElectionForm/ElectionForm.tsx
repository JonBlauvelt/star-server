...
type SetPageFunctionType = (p: Pages) => void;
...
type QuestionProps = {
  ...
  BackPage?: Pages;
  election?: Election;
  applyElectionUpdate?: (e: Election) => void;
  setPage: SetPageFunctionType;
};
            ...
            <Typography align="center" variant="h4" component="h4">
              ...
              {Bullets && (
                <List sx={{ listStyleType: "disc", pl: 4 }}>
                  {Bullets.map((bullet) => (
                    <ListItem key={bullet} sx={{ display: "list-item" }}>
                      {bullet}
                    </ListItem>
                  ))}
                </List>
...
type Props = {
  authSession: any;
  onSubmitElection: (e: Election) => void;
...
const ElectionForm = ({
  ...
  const [election, setElectionData]: [Election, (election: Election) => void] =
    useLocalStorage("Election", prevElectionData);
  useEffect(() => {
    if (prevElectionData != null) {
        ...
        <form id={"electionForm"} onSubmit={(e) => e.preventDefault()}>
          ...
          >
            <div>
              <ElectionDetails
                election={election}
                applyElectionUpdate={applyElectionUpdate}
                getStyle={getStyle}
                onBack={() => setPage("ElectionDetails")}
                onNext={() => setPage("RaceDetails")}
              />
            </div>
          </Fade>
          <Fade
          ...
          <Question
            ...
            Option2={{
              Answer: "No",
              HelpText:
                "For when you want to vote multiple times on one device, demos, tabling, etc.",
              GotoPage: "Scenario2",
              election: election,
              setPage: setPage,
            }}
          ...
          <Question
            ...
            Option1={{
              Answer: "Yes",
              HelpText:
                "Voters will create an account and verify their email adress.",
              GotoPage: "Scenario3",
              election: election,
              setPage: setPage,
            }}
            Option2={{
              Answer: "No",
              HelpText:
                "Voters will be given a unique link that will allow them to vote.",
              GotoPage: "Scenario4",
              election: election,
              setPage: setPage,
            }}
          ...
          <Question
            ...
            Option1={{
              ...
              HelpText:
                "Voters will create an account and verify their email adress.",
              GotoPage: flags.isSet("CUSTOM_REGISTRATION")
                ? "CustomRegister?"
                : "Scenario8",
              election: election,
              setPage: setPage,
          ...
          <Question
            ...
            Option1={{
              Answer: "Yes",
              HelpText:
                "Voters will also provide additional info to cast a provisional ballot.",
              GotoPage: "Scenario7",
              election: election,
              setPage: setPage,
            }}
