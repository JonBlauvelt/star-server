  ...
  return (
    <AppBar
      ...
      sx={{
        ...
        "@media print": { display: "none", boxShadow: "none" },
      }}
    >
      <Toolbar>
        ...
        <Box sx={{ flexGrow: 0, display: { xs: "flex", md: "none" } }}>
          ...
          >
            <MenuItem component={Link} href={"https://equal.vote"}>
                ...
                {flags.isSet("THEMES") && (
                  <>
                    ...
                    <MenuItem
                      color="inherit"
                      onClick={() =>
                        themeSelector.selectColorMode("browserDefault")
                      }
                    >
                      browser default
                    </MenuItem>
